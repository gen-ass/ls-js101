...
3. The conditions for a leap year should be, divisible by 4, not divisible by 100, divisible by 400
4. Final output should be a true or false value

Clarifying questions
1. What are all the requirements to get a true value for a leap year? It is as follows, number/4 = true, number/100 = false, number/400 = true 
...
2. Take the number and divide it by 4 check if it cleanly divides, then divide it by 100 and check if it has a  rest value, lastly check if it cleanly divides by 400, then it is a leap year
...
3. AND && Divide the date by four and check if it cleanly divides, if falsy do not check the second operand if it divides cleanly by 100, if truthy then evaluate the second operand, 
...
4. Return the output to the console
...
function isLeapYear (date) {
	if ((date % 4 === 0 && date % 100 !== 0) || (date % 400 === 0) ) {
		return console.log(true); // console.log(date + ` true`)
	} else {
		return console.log(false); // console.log(date + ` false`)
	}
}
